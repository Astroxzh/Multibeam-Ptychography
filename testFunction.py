...
# sprial = utils.spiral_blade_mask(wavelength=627e-9, f=7.25e-3, N=localMaskN, dx=localMaskdx, n_blades=1, blades_diameter=200e-6, angle=0)
...
# mask = np.pad(mask, (int(N)-int(localMaskN))//2)
